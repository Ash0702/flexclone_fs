...
///scrow start///
int scorw_da_write_end(struct file *file,
                         struct address_space *mapping,
                         loff_t pos, unsigned len, unsigned copied,
                         struct folio *folio, void *fsdata);
int scorw_da_write_begin(struct file *file, struct address_space *mapping,
...
int scorw_da_write_begin(struct file *file, struct address_space *mapping,
                               loff_t pos, unsigned len,
                               struct folio **foliop, void **fsdata){
	return ext4_da_write_begin(file,mapping,pos,len,foliop,fsdata);
...
int scorw_da_write_end(struct file *file,
                         ...
                         loff_t pos, unsigned len, unsigned copied,
                         struct folio *folio, void *fsdata){
        return ext4_da_write_end(file,mapping,pos,len,copied,folio,fsdata);
}
///scrow end///
