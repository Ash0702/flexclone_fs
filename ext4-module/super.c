...
MODULE_ALIAS_FS("ext2-module");
MODULE_ALIAS("ext2-module");
...
MODULE_ALIAS_FS("ext3-module");
MODULE_ALIAS("ext3-module");
...
static int ext4_get_tree(struct fs_context *fc)
{
	int ret = get_tree_bdev(fc,ext4_fill_super);
	////////// scorw start /////////
	scorw_init();
	////////// scorw end /////////
	return ret;
...
MODULE_ALIAS_FS("ext4-module");

/* Shared across all ext4 file systems */
wait_queue_head_t ext4__ioend_wq[EXT4_WQ_HASH_SZ];
extern int (*scorw_is_par_file_balance_dirty)(struct inode*, int);
static int __init ext4_init_fs(void)
{
	int i, err;
	/////scorw start/////
	#define EXT4_MODULE_LOADED 1
	scorw_is_par_file_balance_dirty = scorw_is_par_file;
	printk("Inside ext4_init_fs. EXT4_MODULE_LOADED:  %d\n", EXT4_MODULE_LOADED);
	/////scorw end/////
